...
5. Try it out! Click the extension icon and hit "Try Demo Page"

## 🧪 Try It Out

### **Quick Demo**

Click the AnyText extension icon, go to the "About" tab, and click "Try Demo Page". You'll get a test page where you can play with all the features.
